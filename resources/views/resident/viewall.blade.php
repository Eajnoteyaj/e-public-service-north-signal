				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<a href="{{route('resident.notverified')}}" class="card-text"><small class="text-muted">Total Count</small></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row g-0">
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<h2 class="card-text">---</h2>
							<a href="{{route('resident.verified')}}" class="card-text"><small class="text-muted">Total Count</small></a>
						</div>
					</div>
				</div>
			</div>
